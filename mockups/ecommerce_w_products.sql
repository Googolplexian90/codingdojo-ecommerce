...
--
-- Table structure for table `billlings`
--

DROP TABLE IF EXISTS `billlings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `billlings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `billlings`
--

LOCK TABLES `billlings` WRITE;
/*!40000 ALTER TABLE `billlings` DISABLE KEYS */;
/*!40000 ALTER TABLE `billlings` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `fk_billings` FOREIGN KEY (`billIng_id`) REFERENCES `billlings` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2015-03-25 14:45:55
